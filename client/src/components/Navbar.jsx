...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    if (usernameFromQuery) {
      ...
      axios.get('https://movie-db-up5l.onrender.com/login', { withCredentials: true })
        .then(response => {
  ...
  const handleLogout = () => {
    axios.get('https://movie-db-vert-five.vercel.app/?username=Sriharshini', { withCredentials: true })
      .then(() => {
        setUsername(null);
        window.location.href = 'https://movie-db-vert-five.vercel.app';
      })
      .catch(error => {
  ...
  return (
    <nav style={styles.nav}>
      ...
      {username ? (
        ...
        <a href="https://movie-db-up5l.onrender.com/login" style={styles.loginContainer}>Login</a>
      )}
    </nav>
  );
};
