...
const MovieListDisplay = () => {
  ...
  useEffect(() => {
    fetch('https://movie-db-up5l.onrender.com/movie-lists')
          ...
          {movieLists.map((list, index) => (
            <div key={index} style={styles.item}>
              ...
              <div style={styles.movieDetails}>
                <img src={`https://movie-db-up5l.onrender.com/${list.movieImage}`} alt="Movie" style={styles.img} />
                <div>
              ...
              <div style={{ marginTop: "20px" }}>
                ...
                <div style={styles.castDetails}>
                  <img src={`https://movie-db-up5l.onrender.com/${list.heroImage}`} alt="Hero" style={styles.castImg} />
                  <p>{list.hero}</p>
                </div>
                <div style={styles.castDetails}>
                  <img src={`https://movie-db-up5l.onrender.com/${list.heroineImage}`} alt="Heroine" style={styles.castImg} />
                  <p>{list.heroine}</p>
                </div>
                <div style={styles.castDetails}>
                  <img src={`https://movie-db-up5l.onrender.com/${list.directorImage}`} alt="Director" style={styles.castImg} />
                  <p>{list.director}</p>
                </div>
                <div style={styles.castDetails}>
                  <img src={`https://movie-db-up5l.onrender.com/${list.musicianImage}`} alt="Musician" style={styles.castImg} />
                  <p>{list.musician}</p>
                </div>
                <div style={styles.castDetails}>
                  <img src={`https://movie-db-up5l.onrender.com/${list.comedianImage}`} alt="Comedian" style={styles.castImg} />
                  <p>{list.comedian}</p>
                </div>
              </div>
            </div>
